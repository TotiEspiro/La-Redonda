...
<div class="bg-background-light min-h-[70vh] flex items-center justify-center py-12 md:py-20">
    <div class="container max-w-4xl mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="<?php echo e(route('home')); ?>" class="w-full sm:w-auto bg-button text-white px-8 py-4 rounded-2xl font-bold shadow-lg shadow-blue-100 hover:bg-blue-900 hover:scale-105 transition-all uppercase tracking-widest text-sm">
                Volver al Inicio
            </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\copia_laredo\La-Redonda\resources\views/errors/404.blade.php ENDPATH**/ ?>