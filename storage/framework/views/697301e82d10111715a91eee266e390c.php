    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 justify-center max-w-5xl mx-auto items-stretch">
        ...
        <div class="group bg-white border border-gray-200 rounded-xl hover:border-button hover:shadow-lg transition-all duration-300 flex flex-col overflow-hidden h-full"> 
            ...
            <div class="p-6 flex flex-col flex-grow">
                ...
                <?php echo $__env->make('partials.group-join-button', ['slug' => 'santa_ana', 'nombre' => 'Santa Ana'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>

        <div class="group bg-white border border-gray-200 rounded-xl hover:border-button hover:shadow-lg transition-all duration-300 flex flex-col overflow-hidden h-full">
            <div class="w-full bg-gray-100 md:h-64 overflow-hidden"><img src="<?php echo e(asset('img/grupos_sanjoaquin.png')); ?>" class="w-full h-full object-cover"></div>
            <div class="p-6 flex flex-col flex-grow">
                ...
                <?php echo $__env->make('partials.group-join-button', ['slug' => 'san_joaquin', 'nombre' => 'San Joaquín'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
...
</div><?php /**PATH C:\laragon\www\la_redonda_joven\resources\views/grupos/mayores.blade.php ENDPATH**/ ?>