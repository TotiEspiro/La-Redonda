        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 mb-8 relative overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="flex gap-3">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="px-8 py-4 bg-button text-white rounded-2xl font-black hover:bg-blue-900 transition-all text-sm shadow-lg shadow-blue-100">
                        Editar Perfil
                    </a>
                </div>
            </div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center justify-between group">
                            ...
                            <button onclick="toggleGlobalNotifications()" id="pushToggleBtn" 
                                ...
                                <div id="pushToggleCircle" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
