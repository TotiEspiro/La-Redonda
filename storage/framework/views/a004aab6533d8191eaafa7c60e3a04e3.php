        ...
        <form action="<?php echo e(route('login')); ?>" method="POST" id="loginForm" class="mt-4 space-y-6">
            ...
            <div>
                <div class="flex justify-between items-center mb-2 ml-1">
                    ...
                    <a href="<?php echo e(route('password.request')); ?>" class="text-[9px] font-black text-button uppercase hover:underline">¿Olvidaste tu contraseña?</a>
                </div>
                <div class="relative">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\copia_laredo\La-Redonda\resources\views/auth/login.blade.php ENDPATH**/ ?>