    ...
    <div class="max-w-2xl mx-auto px-4 text-left">
        <div class="bg-white shadow-xl rounded-[2.5rem] overflow-hidden border border-gray-100 animate-fade-in">
            <div class="bg-button px-8 py-8 text-white relative">
                ...
                <p class="text-blue-100 text-xs font-medium opacity-80 mt-1 uppercase tracking-widest">Actualiza tu información de identidad</p>
            </div>
                        ...
                        <div class="bg-blue-50/50 p-6 rounded-[2rem] border border-blue-100 flex flex-col md:flex-row items-center gap-6">
                            <div class="flex-1">
                                ...
                                <p class="text-[9px] text-blue-400 font-bold mt-3 uppercase tracking-widest text-center md:text-left italic">
                                    * Requerida para asignar grupos.
                                </p>
                            </div>
                            <div class="flex-1 text-center md:text-left">
                                <p class="text-[11px] text-blue-700 font-medium leading-relaxed">
                                    Usamos tu edad para asegurarnos de que participes en las comunidades adecuadas para tu etapa de vida.
                                </p>
                            </div>
                        </div>
                        <?php $__errorArgs = ['age'];
