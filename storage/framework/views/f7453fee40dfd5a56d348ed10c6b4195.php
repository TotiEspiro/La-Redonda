...
<div class="min-h-[calc(100vh-180px)] flex items-center justify-center bg-background-light py-4 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-6 md:space-y-8 bg-white p-6 md:p-8 rounded-xl shadow-lg">
        ...
        <form id="loginForm" class="mt-6 space-y-6" action="<?php echo e(route('login')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="space-y-5">
                <div>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="text-red-500 text-xs font-bold mt-2 uppercase"><?php echo e($message); ?></p>
                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-end">
                <a href="<?php echo e(route('password.request')); ?>" class="text-xs font-black text-button hover:underline ">
...
<div id="loadingScreenProgress" class="fixed inset-0 bg-nav-footer flex flex-col items-center justify-center z-50" style="display: none;">
    <div class="text-center px-4">
        <img src="<?php echo e(asset('img/logo_redonda.png')); ?>" alt="La Redonda Joven" class="w-24 md:w-28 mx-auto mb-6 h-auto">
