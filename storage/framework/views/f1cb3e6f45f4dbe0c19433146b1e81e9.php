    ...
    <div class="container max-w-7xl mx-auto px-4">
        <div class="gospel-content text-left max-w-4xl mx-auto">
            ...
            <?php if($evangelioHoy && $evangelioHoy->contenido): ?>
                ...
                <p class="gospel-reference text-text-light text-right font-semibold"><?php echo e($evangelioHoy->referencia); ?></p>
            <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\copia_laredo\La-Redonda\resources\views/home.blade.php ENDPATH**/ ?>