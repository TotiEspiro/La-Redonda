...
<div class="container mx-auto px-0 md:px-4 py-6 md:py-8">
    <div class="bg-white shadow-lg rounded-3xl overflow-hidden border border-gray-100">
        ...
        <div class="bg-button px-8 py-6 text-white">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div class="flex flex-wrap gap-3 w-full md:w-auto">
                    ...
                    <?php if($intentions->count() > 0): ?>
                    <button onclick="confirmDeleteAll()" 
                            class="flex-1 md:flex-none px-6 py-2.5 bg-red-400 hover:bg-red-500 text-white border border-white/20 rounded-xl text-xs font-black uppercase tracking-widest transition-all backdrop-blur-sm flex items-center justify-center gap-2">
                        Vaciar Lista
                    </button>
                    <?php endif; ?>

                    <a href="<?php echo e(route('admin.intentions.print')); ?>" target="_blank" 
        ...
        <div class="p-4 md:p-8">
            ...
            <div class="hidden md:block overflow-x-auto rounded-2xl border border-gray-100">
                <table class="min-w-full divide-y divide-gray-100">
                    ...
                    <tbody class="bg-white divide-y divide-gray-50">
                        <?php $__empty_1 = true; $__currentLoopData = $intentions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $intention): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-blue-50/20 transition-colors">
                            <td class="py-5 px-6 whitespace-nowrap">
                                <div class="text-sm font-bold text-text-dark uppercase tracking-tight"><?php echo e($intention->name); ?></div>
                                <div class="text-[11px] text-text-light font-medium"><?php echo e($intention->email); ?></div>
                            </td>
                            <td class="py-5 px-6">
                                <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    ...
                                    <?php echo e($intention->formatted_type ?? $intention->type); ?>

                                </span>
                            </td>
                            <td class="py-5 px-6">
                                <div class="text-xs text-text-light max-w-xs truncate font-medium" title="<?php echo e($intention->message); ?>">
                                    <?php echo e($intention->message); ?>

                                </div>
                            </td>
                            <td class="py-5 px-6 text-[11px] text-gray-400 font-bold whitespace-nowrap">
                                <?php echo e($intention->created_at->format('d/m/Y H:i')); ?>

                            </td>
                            <td class="py-5 px-6 text-right">
                                <button type="button" 
                                        onclick="confirmSingleDelete(<?php echo e($intention->id); ?>, '<?php echo e($intention->name); ?>')" 
                                        class="text-red-400 hover:text-red-600 p-2 hover:bg-red-50 rounded-xl transition-all">
                                    <img src="<?php echo e(asset('img/icono_eliminar.png')); ?>" class="w-5 h-5">
                                </button>
                            </td>
                        </tr>
            ...
            <div class="md:hidden space-y-4">
                ...
                <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm">
                    <div class="flex justify-between items-start mb-4 gap-3">
                        <div class="min-w-0">
                            <h3 class="text-sm font-bold text-text-dark uppercase tracking-tight truncate"><?php echo e($intention->name); ?></h3>
                            <p class="text-[10px] text-text-light font-medium truncate"><?php echo e($intention->email); ?></p>
                        </div>
                        <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                    ...
                    <div class="bg-gray-50/50 rounded-2xl p-4 mb-4 border border-gray-100">
                        <p class="text-xs text-text-light italic leading-relaxed">"<?php echo e($intention->message); ?>"</p>
                    </div>
                    ...
                    <div class="flex justify-between items-center border-t border-gray-50 pt-4">
                        ...
                        <button type="button" 
                            ...
                            <img src="<?php echo e(asset('img/icono_eliminar.png')); ?>" class="w-4 h-4">
                            Eliminar
                        </button>
                    </div>
                </div>
            ...
            <?php if($intentions->hasPages()): ?>
            <div class="mt-8">
                <?php echo e($intentions->links()); ?>
...
<div id="deleteAllModal" class="hidden fixed inset-0 z-[100] items-center justify-center p-4 bg-black/75 backdrop-blur-md">
    <div class="bg-white rounded-3xl shadow-2xl w-full max-w-sm p-8 text-center animate-slide-up">
        <div class="mx-auto flex items-center justify-center h-16 w-16 rounded-2xl bg-red-600 mb-6 shadow-xl shadow-red-100">
            <img src="<?php echo e(asset('img/icono_eliminar.png')); ?>" class="w-8 h-8 brightness-0 invert">
        </div>
        ...
        <div class="flex flex-col gap-3">
            <form action="<?php echo e(route('admin.intentions.delete-all')); ?>" method="POST" class="w-full">
                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\copia_laredo\La-Redonda\resources\views/admin/intentions/index.blade.php ENDPATH**/ ?>