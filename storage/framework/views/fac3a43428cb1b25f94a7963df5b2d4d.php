...
<div class="container mx-auto px-0 md:px-4 py-6 md:py-8">
    <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-100">
        ...
        <div class="p-4 md:p-6">
            <form action="<?php echo e(route('admin.evangelio-diario.actualizar')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <textarea id="contenido" name="contenido" required rows="8"
                                  ...
                                  placeholder="Ingresa el texto del evangelio..."><?php echo e(old('contenido', $evangelio->contenido)); ?></textarea>
                    ...
                    <div>
                        ...
                        <input type="text" id="referencia" name="referencia" value="<?php echo e(old('referencia', $evangelio->referencia)); ?>" required 
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-button focus:border-button text-base transition-all"
                    ...
                    <div class="mt-4">
                        ...
                        <div class="bg-gospel-bg p-6 md:p-8 rounded-xl border border-blue-100 shadow-inner">
                            ...
                            <p class="italic text-base md:text-lg mb-4 leading-relaxed text-gray-700 text-justify" id="vistaPreviaContenido">
                                <?php echo e($evangelio->contenido ?: 'El texto del evangelio aparecerá aquí...'); ?>

                            </p>
                            <p class="text-gray-600 text-right font-bold text-sm md:text-base" id="vistaPreviaReferencia">
                                <?php echo e($evangelio->referencia ?: 'Referencia bíblica...'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\la_redonda_joven\resources\views/admin/evangelio-diario/editar.blade.php ENDPATH**/ ?>