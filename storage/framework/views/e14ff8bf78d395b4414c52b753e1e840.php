...
<div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-8 prose prose-blue max-w-none text-gray-600 leading-relaxed">
            ...
            <h2 class="text-xl font-bold text-gray-800 mt-6">2. Uso del Diario de La Redonda</h2>
            <p>El "Diario de La Redonda" es una herramienta personal. Aunque el sistema implementa medidas de seguridad (como encriptación de datos), el usuario es responsable de mantener la confidencialidad de su cuenta y contraseña.</p>
            ...
            <div class="mt-10 p-4 bg-blue-50 rounded-lg text-blue-900 text-sm">
