                ...
                <div class="method-left">
                    ...
                    <div class="bank-details bg-background-light p-6 md:p-8 rounded-xl shadow-sm border border-gray-100">
                        <div class="bank-info space-y-4"> 
                            ...
                            <div class="bank-detail flex flex-col md:flex-row md:justify-between md:items-center py-3 border-b border-gray-300">
                                <strong class="text-text-dark min-w-24 mb-1 md:mb-0">Cuenta Corriente nº:</strong>
                                <span class="text-left md:text-right text-sm md:text-base break-words">15153657</span>
                            </div>
                            <div class="bank-detail flex flex-col md:flex-row md:justify-between md:items-center py-3 border-b border-gray-300">
                            ...
                            <div class="bank-detail flex flex-col md:flex-row md:justify-between md:items-center py-3 border-b border-gray-300">
                                ...
                                <span class="text-left md:text-right text-sm md:text-base break-words">30-51907091-6</span>
                            </div>
                            <div class="bank-detail flex flex-col md:flex-row md:justify-between md:items-center py-3 border-b border-gray-300">
