...
<div class="mb-8">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        <a href="<?php echo e(route('admin.users')); ?>" class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-all transform hover:-translate-y-1">
            <div class="flex items-center">
                <div class="p-3 bg-nav-footer rounded-lg flex-shrink-0">
                    <img src="<?php echo e(asset('img/icono_usuarios.png')); ?>" alt="Usuarios" class="h-8 md:h-10 w-auto">
                </div>
                <div class="ml-4 min-w-0">
                    <p class="text-xs text-gray-500 uppercase font-bold tracking-wide truncate">Usuarios</p>
                    <p class="text-xl md:text-2xl font-bold text-gray-800"><?php echo e($stats['total_users']); ?></p>
                </div>
            </div>
        </a>

        <a href="<?php echo e(route('admin.intentions')); ?>" class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-all transform hover:-translate-y-1">
            <div class="flex items-center">
                <div class="p-3 bg-nav-footer rounded-lg flex-shrink-0">
                    <img src="<?php echo e(asset('img/icono_intenciones.png')); ?>" alt="Intenciones" class="h-8 md:h-10 w-auto">
                </div>
                <div class="ml-4 min-w-0">
                    <p class="text-xs text-gray-500 uppercase font-bold tracking-wide truncate">Intenciones</p>
                    <p class="text-xl md:text-2xl font-bold text-gray-800"><?php echo e($stats['total_intentions']); ?></p>
                </div>
            </div>
        </a>

        <a href="<?php echo e(route('admin.donations')); ?>" class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-all transform hover:-translate-y-1">
            <div class="flex items-center">
                <div class="p-3 bg-nav-footer rounded-lg flex-shrink-0">
                    <img src="<?php echo e(asset('img/icono_donaciones_admin.png')); ?>" alt="Donaciones" class="h-8 md:h-10 w-auto">
                </div>
                <div class="ml-4 min-w-0">
                    <p class="text-xs text-gray-500 uppercase font-bold tracking-wide truncate">Donaciones</p>
                    <p class="text-xl md:text-2xl font-bold text-gray-800"><?php echo e($stats['total_donations']); ?></p>
                </div>
            </div>
        </a>

        <a href="<?php echo e(route('admin.announcements.index')); ?>" class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-all transform hover:-translate-y-1">
            <div class="flex items-center">
                <div class="p-3 bg-nav-footer rounded-lg flex-shrink-0">
                    <img src="<?php echo e(asset('img/icono_avisos.png')); ?>" alt="Avisos" class="h-8 md:h-10 w-auto">
                </div>
                <div class="ml-4 min-w-0">
                    <p class="text-xs text-gray-500 uppercase font-bold tracking-wide truncate">Avisos</p>
                    <p class="text-xl md:text-2xl font-bold text-gray-800"><?php echo e($stats['total_announcements'] ?? 0); ?></p>
                </div>
            </div>
        </a>
    </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 flex flex-col overflow-hidden">
        <div class="px-8 py-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
            ...
            <a href="<?php echo e(route('admin.announcements.create')); ?>" class="text-[10px] font-black text-button uppercase tracking-widest hover:underline">+ Nuevo Anuncio</a>
        </div>
                ...
                <div class="flex justify-between items-start">
                    <div class="flex-1 min-w-0 pr-4">
                        <div class="flex items-center gap-2 mb-1">
                            <span class="w-2 h-2 rounded-full <?php echo e($announcement->is_active ? 'bg-green-500' : 'bg-red-500'); ?>"></span>
                            <p class="font-bold text-text-dark truncate uppercase text-sm tracking-tight"><?php echo e($announcement->title); ?></p>
                        </div>
                        <p class="text-xs text-text-light line-clamp-1 mb-3"><?php echo e($announcement->short_description); ?></p>
                        <div class="flex items-center gap-3">
                            <a href="<?php echo e(route('admin.announcements.edit', $announcement->id)); ?>" class="text-[10px] font-black text-button uppercase tracking-widest hover:underline">Editar</a>
                            <button onclick="confirmDeleteAnnouncement(<?php echo e($announcement->id); ?>, '<?php echo e($announcement->title); ?>')" class="text-[10px] font-black text-red-400 uppercase tracking-widest hover:text-red-600 transition-colors">Eliminar</button>
                        </div>
                    </div>
                    <span class="text-[10px] font-bold text-gray-400 bg-white px-2 py-1 rounded-lg border border-gray-100 shadow-sm"><?php echo e($announcement->created_at->format('d/m')); ?></span>
                </div>
            </div>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 flex flex-col overflow-hidden">
        <div class="px-8 py-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
            ...
            <a href="<?php echo e(route('admin.intentions')); ?>" class="text-[10px] font-black text-button uppercase tracking-widest hover:underline">Ver todas</a>
        </div>
        <div class="p-4 flex-1">
            <?php $__empty_1 = true; $__currentLoopData = $stats['recent_intentions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $intention): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="p-4 border-b border-gray-50 last:border-0 hover:bg-blue-50/30 transition-colors rounded-2xl">
                <div class="flex justify-between items-start gap-4">
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 mb-1">
                            <p class="font-bold text-text-dark text-xs uppercase tracking-tight truncate"><?php echo e($intention->name); ?></p>
                            <span class="px-2 py-0.5 bg-sky-50 text-button text-[9px] font-black rounded-md border border-sky-100 uppercase"><?php echo e($intention->formatted_type); ?></span>
                        </div>
                        <p class="text-xs text-text-light italic line-clamp-2">"<?php echo e($intention->message); ?>"</p>
                    </div>
                    <span class="text-[10px] font-bold text-gray-400 mt-1"><?php echo e($intention->created_at->format('H:i')); ?></span>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<div class="mt-8 bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="px-8 py-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
        ...
        <a href="<?php echo e(route('admin.users')); ?>" class="text-[10px] font-black text-button uppercase tracking-widest hover:underline">Gestionar Todos</a>
    </div>
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100 hover:border-button/30 transition-all"
                ...
                <div class="flex items-center gap-4 min-w-0">
                    ...
                    <div class="min-w-0">
                        <p class="font-bold text-text-dark text-sm uppercase tracking-tight truncate"><?php echo e($user->name); ?></p>
                        <p class="text-[10px] text-text-light truncate"><?php echo e($user->email); ?></p>
                    </div>
                </div>
                <div class="flex gap-2 ml-4">
                    ...
                    <button onclick="confirmDeleteUser(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>')"
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <?php $__currentLoopData = $grupos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50/50">
                                    <td class="px-6 py-4 font-bold text-text-dark text-xs uppercase"><?php echo e($label); ?></td>
                                    <td class="px-6 py-4 text-center">
                                        <input type="checkbox" name="member_<?php echo e($key); ?>" id="member_<?php echo e($key); ?>" class="w-5 h-5 text-button rounded-md border-gray-200">
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <input type="checkbox" name="admin_<?php echo e($key); ?>" id="admin_<?php echo e($key); ?>" 
                                               onchange="document.getElementById('member_<?php echo e($key); ?>').checked = this.checked" 
...
<div id="deleteModal" class="hidden fixed inset-0 z-[100] items-center justify-center p-4 bg-black/75 backdrop-blur-md">
    <div class="bg-white rounded-3xl shadow-2xl w-full max-w-sm p-8 text-center">
        <div class="mx-auto flex items-center justify-center h-16 w-16 rounded-2xl bg-red-50 mb-6">
            <img src="<?php echo e(asset('img/icono_eliminar.png')); ?>" class="w-8 h-8">
        </div>
...
<?php if(session('success') || session('error')): ?>
    window.onload = function() {
        const isSuccess = <?php echo e(session('success') ? 'true' : 'false'); ?>;
        showStatus(isSuccess ? '¡Completado!' : 'Error', "<?php echo e(session('success') ?? session('error')); ?>", isSuccess);
    };
<?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\copia_laredo\La-Redonda\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>