        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center">
                    <img class="block h-10 w-auto mr-3 md:h-14" src="<?php echo e(asset('img/logo_redonda_texto_vertical.png')); ?>" alt="Logo Móvil">
            ...
            <div class="mobile-menu hidden absolute top-full right-0 bg-nav-footer w-80 max-w-full shadow-lg rounded-bl-lg z-40 border-2 border-button" id="mobileMenu">
                <div class="flex flex-col space-y-1 p-4">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-6 py-4 text-text-dark font-medium hover:bg-button hover:text-white rounded transition-colors">Inicio</a>
                    <a href="<?php echo e(route('admin.users')); ?>" class="block px-6 py-4 text-text-dark font-medium hover:bg-button hover:text-white rounded transition-colors">Usuarios</a>
                    <a href="<?php echo e(route('admin.intentions')); ?>" class="block px-6 py-4 text-text-dark font-medium hover:bg-button hover:text-white rounded transition-colors">Intenciones</a>
                    <a href="<?php echo e(route('admin.donations')); ?>" class="block px-6 py-4 text-text-dark font-medium hover:bg-button hover:text-white rounded transition-colors">Donaciones</a>
                    <a href="<?php echo e(route('admin.announcements.index')); ?>" class="block px-6 py-4 text-text-dark font-medium hover:bg-button hover:text-white rounded transition-colors">Anuncios</a>
                    <a href="<?php echo e(route('admin.evangelio-diario.editar')); ?>" class="block px-6 py-4 text-text-dark font-medium hover:bg-button hover:text-white rounded transition-colors">Evangelio del Día</a>
                    
                    <div class="border-t border-gray-300 pt-4 mt-4 space-y-2">      
                        <a href="<?php echo e(route('profile.show')); ?>" class="block text-center bg-button text-white py-2 px-4 rounded hover:bg-blue-500 transition-colors">Ver Sitio Web</a>
...
</html><?php /**PATH C:\laragon\www\copia_laredo\La-Redonda\resources\views/layouts/admin.blade.php ENDPATH**/ ?>