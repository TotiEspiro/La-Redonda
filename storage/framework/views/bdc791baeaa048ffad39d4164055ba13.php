                ...
                <div id="section-seguridad" class="tab-content bg-white rounded-[2rem] shadow-xl border border-gray-100 overflow-hidden animate-fade-in hidden md:block">
                    ...
                    <div class="p-8">
                        ...
                        <form action="<?php echo e(route('grupos.update-password', $groupRole)); ?>" method="POST" class="space-y-6">
                            ...
                            <button type="submit" class="w-full py-4 bg-blue-900 text-white rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-lg hover:bg-blue-950 transition-all active:scale-95">Actualizar clave de acceso</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white w-full max-w-md rounded-t-[2.5rem] sm:rounded-[2.5rem] shadow-2xl overflow-hidden animate-slide-up">
        ...
        <form id="uploadForm" class="p-8 space-y-6">
            ...
            <div>
                ...
                <textarea name="description" rows="2" placeholder="Descripción del archivo..." class="w-full p-4 bg-gray-50 border border-gray-200 rounded-2xl outline-none font-medium focus:ring-2 focus:ring-button resize-none text-sm"></textarea>
            </div>
            <div>
            ...
            <button type="submit" class="w-full py-5 bg-button text-white rounded-[1.5rem] font-black text-sm shadow-xl shadow-blue-100 hover:bg-blue-900 transition-all active:scale-95">Subir Material</button>
        </form>
    </div>
</div>
