    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 justify-center items-stretch max-w-7xl mx-auto">
        ...
        <div class="group bg-white border border-gray-200 rounded-xl hover:border-button hover:shadow-lg transition-all duration-300 flex flex-col overflow-hidden h-full">
            <div class="w-full bg-gray-100 md:h-64 flex items-center justify-center overflow-hidden">
                <img src="<?php echo e(asset('img/grupo_comedor.jpg')); ?>" onerror="this.src='<?php echo e(asset('img/logo_redonda.png')); ?>'; this.classList.add('p-12', 'opacity-50');" alt="Comedor" class="w-full h-full object-cover">
            </div>
            <div class="p-6 flex flex-col flex-grow">
                ...
                <?php echo $__env->make('partials.group-join-button', ['slug' => 'comedor', 'nombre' => 'Comedor'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
        ...
        <div class="group bg-white border border-gray-200 rounded-xl hover:border-button hover:shadow-lg transition-all duration-300 flex flex-col overflow-hidden h-full">
            <div class="w-full bg-gray-100 md:h-64 flex items-center justify-center overflow-hidden">
                <img src="<?php echo e(asset('img/grupo_caritas.png')); ?>" onerror="this.src='<?php echo e(asset('img/logo_redonda.png')); ?>'; this.classList.add('p-12', 'opacity-50');" alt="Caritas" class="w-full h-full object-cover">
            </div>
            <div class="p-6 flex flex-col flex-grow">
                <div class="flex flex-col mb-4">
