...
<div class="min-h-[calc(100vh-180px)] flex items-center justify-center bg-background-light py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 bg-white p-8 md:p-10 rounded-[2.5rem] shadow-xl border border-gray-100">
        ...
        <form action="<?php echo e(route('password.email')); ?>" method="POST" id="forgotPasswordForm" class="mt-8 space-y-6">
            <?php echo csrf_field(); ?>
            <div>
            ...
            <div class="text-center">
                <a href="<?php echo e(route('login')); ?>" class="text-[10px] text-button font-black uppercase hover:underline">Volver al inicio</a>
            </div>
        </form>
    </div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\copia_laredo\La-Redonda\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>