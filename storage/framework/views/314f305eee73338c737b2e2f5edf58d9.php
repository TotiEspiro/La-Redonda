...
<template id="mindMapNodeTemplate">
    <div class="mind-map-node absolute bg-white border-2 border-blue-500 rounded-xl p-3 shadow-lg cursor-move min-w-[160px] max-w-[200px] group hover:shadow-xl transition-shadow" style="touch-action: none;">
        ...
        <div class="flex justify-center gap-3 mt-2 pt-2 border-t border-gray-100">
            ...
            <button type="button" class="connect-node text-gray-400 hover:text-blue-500 p-1.5 rounded hover:bg-blue-50 transition-colors" title="Conectar"><img src="../img/icono_enlazar.png" class="w-6 h-6" alt="Unir"></button>
            <button type="button" class="delete-node text-gray-400 hover:text-red-500 p-1.5 rounded hover:bg-red-50 transition-colors" title="Eliminar"><img src="../img/icono_eliminar.png" class="w-6 h-6" alt="Eliminar"></button>
        </div>
    </div>
</template>
