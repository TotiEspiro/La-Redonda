            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div class="flex flex-wrap gap-3 w-full md:w-auto">
                    ...
                    <button onclick="confirmDeleteAll()" 
                        ...
                        <img src="<?php echo e(asset('img/icono_eliminar.png')); ?>" class="w-4 h-4 brightness-0 invert">
                        Vaciar Lista
                    </button>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\la_redonda_joven\resources\views/admin/intentions/index.blade.php ENDPATH**/ ?>