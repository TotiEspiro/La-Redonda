        ...
        <div class="bg-white rounded-[2rem] md:rounded-3xl shadow-sm border border-gray-100 p-6 md:p-8 mb-8 relative overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="text-center md:text-left flex-1 min-w-0 w-full">
                    <h1 class="text-2xl md:text-3xl font-black text-text-dark uppercase tracking-tighter truncate"><?php echo e($user->name); ?></h1>
                ...
                <div class="w-full md:w-auto">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="block w-full text-center px-8 py-4 bg-button text-white rounded-2xl font-black hover:bg-blue-900 transition-all text-xs shadow-lg shadow-blue-100 uppercase tracking-widest active:scale-95">
                        Editar Perfil
                    </a>
                </div>
            </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="relative">
                            ...
                            <?php else: ?>
                                <div class="p-4 bg-red-50 border border-red-100 rounded-2xl">
                                    ...
                                    <a href="<?php echo e(route('profile.edit')); ?>" class="text-red-600 font-black text-[9px] uppercase underline tracking-widest">Completar ahora</a>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="pt-6 border-t border-gray-50">
                            <a href="<?php echo e(route('profile.change-password')); ?>" class="group text-button font-black text-[10px] uppercase tracking-widest hover:underline flex items-center gap-3 transition-all">
                ...
                <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-6 md:p-8">
                    ...
                    <div class="space-y-8">
                        ...
                        <?php $inGroup = $user->roles->whereNotIn('name', ['admin', 'superadmin', 'usuario'])->isNotEmpty(); ?>
                        <?php if(!$inGroup): ?>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 flex flex-col h-full overflow-hidden">
                    ...
                    <div class="flex-1 overflow-y-auto max-h-[700px] md:max-h-[850px] custom-scrollbar" id="notif-history-container">
                        ...
                        <div class="p-5 md:p-6 border-b border-gray-50 hover:bg-gray-50/50 transition-colors relative group <?php echo e(is_null($notification->read_at) ? 'bg-blue-50/20' : ''); ?>">
                            ...
                            <div class="flex items-start gap-4 md:gap-6">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex justify-between items-start mb-1">
                                        <h4 class="font-black text-text-dark text-xs md:text-sm uppercase tracking-tight truncate pr-2"><?php echo e($nData['title'] ?? 'Aviso'); ?></h4>
                                        <span class="text-[8px] md:text-[9px] text-gray-400 font-bold uppercase flex-shrink-0 tracking-tighter"><?php echo e(\Carbon\Carbon::parse($notification->created_at)->diffForHumans()); ?></span>
                                    </div>
                                    <p class="text-[11px] md:text-xs text-text-light leading-relaxed mb-3 font-medium line-clamp-2"><?php echo e($nData['message'] ?? 'Actualización.'); ?></p>
                                    <?php if($nData['link'] ?? ($nData['url'] ?? null)): ?>
                                        <a href="<?php echo e($nData['link'] ?? $nData['url']); ?>" class="inline-flex items-center text-[9px] md:text-[10px] font-black text-button uppercase tracking-widest hover:translate-x-1 transition-transform gap-1">
                        ...
                        <div class="py-32 text-center opacity-40">
                            <img src="<?php echo e(asset('img/icono_campana.png')); ?>" class="w-16 h-16 mx-auto mb-4 grayscale">
