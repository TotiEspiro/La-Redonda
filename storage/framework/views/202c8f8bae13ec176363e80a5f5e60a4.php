    ...
    <div class="container max-w-7xl mx-auto px-4 pt-8">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 mb-8 relative overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="flex gap-3">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="px-8 py-4 bg-button text-white rounded-2xl font-black hover:bg-blue-900 transition-all text-sm shadow-lg shadow-blue-100 uppercase tracking-widest">
                        Editar Perfil
                    </a>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="relative">
                            ...
                            <?php else: ?>
                                <div class="p-4 bg-red-50 border border-red-100 rounded-2xl">
                                    ...
                                    <a href="<?php echo e(route('profile.edit')); ?>" class="text-red-600 font-black text-[9px] uppercase underline">Completar ahora</a>
                                </div>
                            <?php endif; ?>
                        </div>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    <h3 class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-6">Panel de Privacidad</h3>
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center justify-between group">
                            <div class="flex flex-col pr-4">
                                ...
                                <span class="text-[9px] text-gray-400 font-bold uppercase">Noticias generales</span>
                            </div>
                            <button onclick="toggleNotification('announcements')" id="btn-announcements" 
                                ...
                                <div id="circle-announcements" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <div class="flex items-center justify-between group">
                            <div class="flex flex-col pr-4">
                                <span class="text-xs font-black text-text-dark uppercase tracking-tight">Comunidad Parroquial</span>
                                <span class="text-[9px] text-gray-400 font-bold uppercase">Grupos y Materiales</span>
                            </div>
                            <button onclick="toggleNotification('community')" id="btn-community" 
                                ...
                                <div id="circle-community" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    'absolute top-1 w-5 h-5 rounded-full bg-white shadow-sm transition-all',
                        ...
                        <div class="flex items-center justify-between group">
                            <div class="flex flex-col pr-4">
                                <span class="text-xs font-black text-text-dark uppercase tracking-tight">Aportes y Oración</span>
                                <span class="text-[9px] text-gray-400 font-bold uppercase">Donaciones e Intenciones</span>
                            </div>
                            <button onclick="toggleNotification('donations_intentions')" id="btn-donations_intentions" 
                                ...
                                <div id="circle-donations_intentions" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    'absolute top-1 w-5 h-5 rounded-full bg-white shadow-sm transition-all',
                        ...
                        <?php $inGroup = $user->roles->whereNotIn('name', ['admin', 'superadmin'])->isNotEmpty(); ?>
                        <?php if(!$inGroup): ?>
                        <div class="p-4 bg-orange-50 rounded-2xl border border-orange-100">
                            <p class="text-[9px] text-orange-600 font-bold leading-relaxed uppercase">
                                * Nota: Para recibir avisos de comunidad debes pertenecer a un grupo parroquial activo.
                            </p>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="flex-1 overflow-y-auto max-h-[850px] custom-scrollbar" id="notif-history-container">
                        ...
                        <div class="p-6 border-b border-gray-50 hover:bg-gray-50/50 transition-colors relative group <?php echo e(is_null($notification->read_at) ? 'bg-blue-50/20' : ''); ?>">
                            ...
                            <div class="flex items-start gap-6">
                                <div class="p-4 rounded-2xl bg-white shadow-sm border border-gray-100 transform group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
                                    ...
                                    ?>
                                    <?php if(str_contains($type, 'anuncio')): ?>
                                    ...
                                    <?php elseif(str_contains($type, 'donacion')): ?>
                                        <svg class="w-6 h-6 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    <?php elseif(str_contains($type, 'material')): ?>
                                    ...
                                    <?php elseif(str_contains($type, 'solicitud')): ?>
                                    ...
                                    <?php elseif(str_contains($type, 'aceptado')): ?>
                                ...
                                <div class="flex-1 min-w-0 text-left">
                                    ...
                                    <p class="text-xs text-text-light leading-relaxed mb-4 font-medium"><?php echo e($nData['message'] ?? 'Actualización en tu cuenta.'); ?></p>
                        ...
                        <div class="p-32 text-center" id="empty-notif-state">
                            <div class="w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6">
                                <div class="w-15 h-15 opacity-50 text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <img src="img/icono_campana.png" alt="Notificación"></div>
                            </div>
...
<div id="statusModal" class="hidden fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-[140] p-4">
...
<script>
/**
 * Alterna notificaciones granulares (announcements, community, donations)
 */
async function toggleNotification(type) {
    ...
    try {
        const response = await fetch('<?php echo e(route('profile.update-preference')); ?>', {
            method: 'POST',
            headers: {
        ...
        console.error('Fallo en la actualización');
    }
}
...
async function executeClearNotifications() {
    ...
    try {
        const response = await fetch('<?php echo e(route('profile.notifications.clear')); ?>', {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Content-Type': 'application/json',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\copia_laredo\La-Redonda\resources\views/profile/show.blade.php ENDPATH**/ ?>