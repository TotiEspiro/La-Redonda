...
<div class="py-8 md:py-12">
    <div class="container max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <a href="<?php echo e(route('grupos.catequesis')); ?>" class="group bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-all transform hover:-translate-y-1 border border-gray-100">
                <div class="w-16 h-16 mx-auto mb-4 bg-nav-footer rounded-full flex items-center justify-center group-hover:bg-button transition-colors">
                    <img src="<?php echo e(asset('img/icono_catequesis.png')); ?>" alt="Catequesis" class="h-8 md:h-10 w-auto">
                </div>
            ...
            <a href="<?php echo e(route('grupos.jovenes')); ?>" class="group bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-all transform hover:-translate-y-1 border border-gray-100">
                <div class="w-16 h-16 mx-auto mb-4 bg-nav-footer rounded-full flex items-center justify-center group-hover:bg-button transition-colors">
                    <img src="<?php echo e(asset('img/icono_gruposjovenes.png')); ?>" alt="Jovenes" class="h-8 md:h-10 w-auto">
                </div>
            ...
            <a href="<?php echo e(route('grupos.mayores')); ?>" class="group bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-all transform hover:-translate-y-1 border border-gray-100">
                <div class="w-16 h-16 mx-auto mb-4 bg-nav-footer rounded-full flex items-center justify-center group-hover:bg-button transition-colors">
                    <img src="<?php echo e(asset('img/icono_gruposmayores.png')); ?>" alt="Mayores" class="h-8 md:h-10 w-auto">
                </div>
            ...
            <a href="<?php echo e(route('grupos.especiales')); ?>" class="group bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-all transform hover:-translate-y-1 border border-gray-100">
                <div class="w-16 h-16 mx-auto mb-4 bg-nav-footer rounded-full flex items-center justify-center group-hover:bg-button transition-colors">
                     <img src="<?php echo e(asset('img/icono_gruposespeciales.png')); ?>" alt="Grupos Especiales" class="h-8 md:h-10 w-auto">
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\copia_laredo\La-Redonda\resources\views/grupos/index.blade.php ENDPATH**/ ?>