...
<div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-8 prose prose-blue max-w-none text-gray-600 leading-relaxed">
            ...
            <p>Recopilamos información personal básica (nombre, correo electrónico) para la creación de cuentas. Además, almacenamos el contenido generado en su Diario de La Redonda e Intenciones de Misa.</p>
            ...
            <h2 class="text-xl font-bold text-gray-800 mt-6">5. Cookies y Notificaciones</h2>
