    ...
    <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-2xl border border-gray-100">
        <div class="text-center">
            <div class="mx-auto h-20 w-20 bg-blue-50 rounded-2xl flex items-center justify-center shadow-inner mb-6">
                <img src="<?php echo e(asset('img/icono_grupos.png')); ?>" class="h-12 w-12 object-contain" alt="Icono de Grupo">
            </div>
            ...
            <p class="mt-4 text-sm text-gray-500 font-medium">
                ...
                <span class="font-black text-button uppercase text-lg"><?php echo e($group->name); ?></span>.
            </p>
        ...
        <form class="mt-8 space-y-6" action="<?php echo e(route('grupos.verify-password', $groupRole)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="space-y-4">
                <div class="relative">
        ...
        <div class="text-center border-t border-gray-50">
            <a href="<?php echo e(route('dashboard')); ?>" class="text-[10px] font-black text-gray-400 hover:text-button uppercase tracking-widest transition-colors">
                ← Volver al inicio
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\copia_laredo\La-Redonda\resources\views/grupos/verify-password.blade.php ENDPATH**/ ?>