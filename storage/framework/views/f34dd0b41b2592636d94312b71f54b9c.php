    ...
    <div class="container max-w-7xl mx-auto px-4">
        <div class="footer-logo text-center mb-8 pb-8">
            <div class="footer-logo-img flex justify-center">
                <div class="h-auto w-auto flex items-center justify-center">
                    <img src="<?php echo e(asset('img/logo_redonda_texto.png')); ?>" alt="Logo Redonda" class="h-14 md:h-18 w-auto">
                </div>
            </div>
        </div>
        ...
        <div class="footer-grid grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div class="footer-section px-4 border-b-2 border-black pb-8 md:pb-0 md:border-b-0 md:border-r-2 last:border-0">
                ...
                <ul class="footer-links space-y-3 text-center md:text-left">
                    <li><a href="<?php echo e(url('/grupos/jovenes')); ?>" class="text-text-dark no-underline hover:text-button hover:underline transition-colors block py-1">Juveniles</a></li>
                    <li><a href="<?php echo e(url('/grupos/jovenes')); ?>" class="text-text-dark no-underline hover:text-button hover:underline transition-colors block py-1">Carlo Acutis</a></li>
                    <li><a href="<?php echo e(url('/grupos/jovenes')); ?>" class="text-text-dark no-underline hover:text-button hover:underline transition-colors block py-1">Juan Pablo II</a></li>
                    <li><a href="<?php echo e(url('/grupos/especiales')); ?>" class="text-text-dark no-underline hover:text-button hover:underline transition-colors block py-1">Noche de Caridad</a></li>
                    <li><a href="<?php echo e(url('/grupos/especiales')); ?>" class="text-text-dark no-underline hover:text-button hover:underline transition-colors block py-1">Grupo Misionero</a></li>
                    <li><a href="<?php echo e(url('/grupos/jovenes')); ?>" class="text-text-dark no-underline hover:text-button hover:underline transition-colors block py-1">Coro Parroquial</a></li>
                </ul>
            </div>
        ...
        <div class="footer-bottom flex flex-col md:flex-row justify-between items-center pt-4 gap-4 text-center md:text-left">
            ...
            <div class="legal-links flex flex-col md:flex-row gap-4 md:gap-6">
                <a href="<?php echo e(route('legal.terminos')); ?>" class="text-sm text-text-light no-underline hover:text-button hover:underline transition-colors">Términos y Condiciones</a>
                <a href="<?php echo e(route('legal.privacidad')); ?>" class="text-sm text-text-light no-underline hover:text-button hover:underline transition-colors">Política de Privacidad</a>
            </div>
        </div>
    </div>
</footer>
...
</script><?php /**PATH C:\laragon\www\copia_laredo\La-Redonda\resources\views/partials/footer.blade.php ENDPATH**/ ?>