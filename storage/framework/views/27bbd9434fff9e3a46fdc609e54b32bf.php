        ...
        <?php 
            $grupos = [
                [
                    ...
                    'nombre' => 'Cáritas', 
                    'categoria' => 'Servicio', 
                    'img' => 'grupo_caritas.png', 
                    'link' => '',
                    'desc' => 'Asistencia y promoción humana para familias necesitadas.'
                ],
                [
                    'slug' => 'comedor', 
                    'nombre' => 'Comedor', 
                    'categoria' => 'Servicio', 
                    'img' => 'grupo_comedor.jpg', 
                    'link' => '',
                    'desc' => 'Servicio de alimentación para personas en situación de calle.'
                ],
                [
                    'slug' => 'caridad', 
                    'nombre' => 'Noche de Caridad', 
                    'categoria' => 'Servicio Nocturno', 
                    'img' => 'grupo_caridad.jpg', 
                    'link' => '',
                    'desc' => 'Recorrida nocturna para acompañar y asistir con alimentos a hermanos en situación de calle.'
                ],
            ];
        ...
        <?php $__currentLoopData = $grupos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="group-card group bg-white border border-gray-200 rounded-xl hover:border-button hover:shadow-lg transition-all duration-300 flex flex-col overflow-hidden h-full cursor-pointer lg:cursor-default" onclick="toggleCard(this)">
                <div class="w-full bg-gray-100 md:h-64 flex items-center justify-center overflow-hidden">
                    <img src="<?php echo e(asset('img/'.$g['img'])); ?>" class="w-full h-full object-cover" onerror="this.src='<?php echo e(asset('img/logo_redonda.png')); ?>'; this.classList.add('p-12', 'opacity-50');">
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\copia_laredo\La-Redonda\resources\views/grupos/especiales.blade.php ENDPATH**/ ?>