    ...
    <div class="container max-w-5xl mx-auto px-4 text-left">
        ...
        <div class="bg-button p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem] border border-gray-100 shadow-sm flex flex-col md:flex-row justify-between items-center mb-8 gap-6 text-left">
            <div class="flex items-center gap-4 w-full md:w-auto">
                <a href="<?php echo e(route('grupos.dashboard', $groupRole)); ?>" class="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-gray-400 hover:bg-blue-900 hover:text-white transition-all shadow-inner flex-shrink-0">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M15 19l-7-7 7-7"/></svg>
                </a>
                <div class="min-w-0">
                    <h1 class="text-2xl md:text-3xl font-black text-white uppercase tracking-tighter leading-none truncate"><?php echo e($group->name); ?></h1>
                    ...
                    <tbody class="divide-y divide-gray-50" id="membersTableBody">
                        ...
                        <tr class="member-row hover:bg-blue-50/30 transition-colors group">
                            <td class="px-8 py-6">
                                <div class="flex items-center gap-4 text-left">
                                    ...
                                    <div>
                                        ...
                                        <?php $joinedDate = $m->joined_at_group ? \Carbon\Carbon::parse($m->joined_at_group) : $m->created_at; ?>
                            ...
                            <td class="px-8 py-6 text-right">
                                <?php if(Auth::id() !== $m->id): ?>
                                    <button onclick="confirmRemoveMember(<?php echo e($m->id); ?>, '<?php echo e($m->name); ?>', '<?php echo e($groupRole); ?>')" class="p-3 bg-red-50 text-red-300 hover:text-red-500 rounded-xl transition-all border border-red-50 shadow-sm">
                ...
                <div class="member-row bg-white rounded-[2rem] p-6 shadow-sm border border-gray-100 transition-all active:scale-[0.98]">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="min-w-0 flex-1">
                            <h4 class="text-sm font-black text-gray-900 uppercase tracking-tight truncate leading-none"><?php echo e($m->name); ?></h4>
                            <p class="text-[11px] text-gray-400 font-bold truncate mt-1"><?php echo e($m->email); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between mt-6 pt-4 border-t border-gray-50">
                        <div class="flex flex-col">
                            ...
                            <?php $joinedDate = $m->joined_at_group ? \Carbon\Carbon::parse($m->joined_at_group) : $m->created_at; ?>
                            <span class="text-[10px] font-bold text-gray-500"><?php echo e($joinedDate->format('d/m/Y')); ?></span>
                        </div>

                        <?php if(Auth::id() !== $m->id): ?>
                            <button onclick="confirmRemoveMember(<?php echo e($m->id); ?>, '<?php echo e($m->name); ?>', '<?php echo e($groupRole); ?>')" 
