        ...
        <div class="group-card group bg-white border border-gray-200 rounded-xl hover:border-button hover:shadow-lg transition-all duration-300 flex flex-col overflow-hidden h-full cursor-pointer lg:cursor-default" onclick="toggleCard(this)">
            ...
            <div class="p-6 flex flex-col flex-grow">
                ...
                <div class="mt-auto flex flex-col gap-3">
                    <?php echo $__env->make('partials.group-join-button', ['slug' => 'catequesis_ninos', 'nombre' => 'Catequesis Niños'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\la_redonda_joven\resources\views/grupos/catequesis.blade.php ENDPATH**/ ?>