    ...
    <div class="bg-button text-white shadow-md md:shadow-none md:rounded-t-xl sticky top-0 z-20 md:static">
        <div class="container mx-auto px-4 py-4 md:px-6 md:py-5 md:mt-8">
            <div class="flex justify-between items-center">
                ...
                <a href="<?php echo e(route('admin.announcements.create')); ?>" class="md:hidden bg-white/20 hover:bg-white/30 text-white px-3 py-1.5 rounded-lg text-xs font-bold backdrop-blur-sm transition-colors border border-white/30 flex items-center gap-1 uppercase">
        ...
        <div class="md:hidden space-y-3 pb-4 mt-2">
            <?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden mx-1">
                    <div class="flex">
                        <div class="w-24 bg-gray-100 flex-shrink-0 relative border-r border-gray-100">
                            <?php if($announcement->image_url): ?>
                                <img src="<?php echo e($announcement->image_url); ?>" alt="" class="w-full h-full object-cover absolute inset-0">
                            <?php else: ?>
                        ...
                        <div class="flex-1 p-4 flex flex-col justify-between min-w-0">
                            <div>
                                <h3 class="text-sm font-black text-text-dark leading-tight mb-1 line-clamp-2 uppercase tracking-tight"><?php echo e($announcement->title); ?></h3>
                                <p class="text-[11px] text-text-light line-clamp-2 mb-3 font-medium">
                                    <?php echo e($announcement->short_description ?? 'Sin descripción'); ?>
                            ...
                            <div>
                                <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    ...
                                    <span class="w-1.5 h-1.5 rounded-full mr-1.5 <?php echo e($announcement->is_active ? 'bg-green-500' : 'bg-red-500'); ?>"></span>
                                    <?php echo e($announcement->is_active ? 'Publicado' : 'Borrador'); ?>
                    ...
                    <div class="flex divide-x divide-gray-100 border-t border-gray-100 bg-gray-50/50">
                         ...
                         <button type="button" 
                            onclick="confirmDeleteAnnouncement(<?php echo e($announcement->id); ?>, '<?php echo e($announcement->title); ?>')"
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="flex flex-col items-center justify-center py-20 px-4 text-center">
                    ...
                    <a href="<?php echo e(route('admin.announcements.create')); ?>" class="bg-button text-white px-8 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-blue-100">
                        Crear Anuncio
                    </a>
                </div>
            <?php endif; ?>
                                ...
                                <td class="py-4 px-6 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-14 w-14 bg-gray-50 rounded-2xl overflow-hidden border border-gray-100 shadow-inner group-hover:border-button/30 transition-all">
                                            <?php if($announcement->image_url): ?>
                                                <img src="<?php echo e($announcement->image_url); ?>" alt="" class="h-14 w-14 object-cover">
                                            <?php else: ?>
                                        ...
                                        <div class="ml-5">
                                            <div class="text-sm font-black text-text-dark uppercase tracking-tight"><?php echo e($announcement->title); ?></div>
                                            <div class="flex items-center mt-1">
                                                <span class="text-[9px] font-black text-button bg-blue-50 px-2 py-0.5 rounded-md border border-blue-100 uppercase tracking-widest">Posición: <?php echo e($announcement->order); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td class="py-4 px-6 hidden lg:table-cell">
                                    <div class="text-xs text-text-light max-w-xs truncate font-medium"><?php echo e($announcement->short_description); ?></div>
                                </td>
                                <td class="py-4 px-6 whitespace-nowrap">
                                    <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
...
<?php if(session('success') || session('error')): ?>
    window.addEventListener('load', function() {
        ...
        const msg = "<?php echo e(session('success') ?? session('error')); ?>";
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\copia_laredo\La-Redonda\resources\views/admin/announcements/index.blade.php ENDPATH**/ ?>