...
<div class="bg-gray-50 min-h-screen pb-20">
        ...
        <div class="container max-w-7xl mx-auto px-4 relative z-10">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                ...
                <div class="flex flex-wrap gap-3 w-full md:w-auto">
                    ...
                    {{-- NUEVO BOTÓN: Acceso a todos los miembros --}}
                    <a href="{{ route('grupos.members', $groupRole) }}" class="fflex-1 md:flex-none bg-blue-900 text-white border border-white/20 px-6 py-3 rounded-2xl font-black  text-sm  text-center backdrop-blur-sm hover:scale-105 transition-all">
                        Miembros
                    </a>
                </div>
            </div>
    ...
    <div class="container max-w-7xl mx-auto px-4 -mt-12 relative z-20">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            {{-- SECCIÓN DE COMUNIDAD (ÚLTIMOS AGREGADOS) --}}
                    ...
                    <div class="hidden md:block overflow-x-auto">
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                {{-- Usamos latestMembers enviado por el controlador --}}
                ...
                <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                    <div class="px-8 py-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/50">
                        ...
                        <div class="flex items-center gap-4">
                            @if(count($requests) > 0)
                            <form action="{{ route('grupos.requests.delete-all', $groupRole) }}" method="POST" onsubmit="return confirm('¿Eliminar TODAS las solicitudes?')">
                                @csrf @method('DELETE')
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="p-5 bg-blue-100 rounded-3xl border border-purple-100 group hover:bg-blue-200 transition-colors flex items-center justify-between">
                            <div>
                                ...
                                <span class="text-3xl font-black text-blue-900 leading-none">{{ DB::table('group_materials')->where('group_role', $slug)->count() }}</span>
                            </div>
                            <div class="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform">
...
{{-- MODALES DE ESTADO Y CONFIRMACIÓN --}}
