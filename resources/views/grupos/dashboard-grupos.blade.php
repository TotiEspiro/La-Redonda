...
<div class="bg-gray-50 min-h-screen pb-20">
    ...
    <div>
        ...
        <div class="relative group">
            {{-- Cambiamos type="text" a type="password" para que sea secreta por defecto --}}
            ...
            <button type="button" onclick="toggleGroupPassword()" 
                ...
                {{-- Ojo Cerrado (Se ve cuando el texto está oculto) --}}
                ...
                {{-- Ojo Abierto (Se ve cuando el texto es visible) --}}
