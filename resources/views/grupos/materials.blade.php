            ...
            <div class="w-full lg:w-auto">
                <div class="flex flex-wrap justify-center md:grid md:grid-cols-3 gap-2">
                    <button onclick="filterMaterials('all')" 
                            class="filter-btn active flex-1 md:flex-none whitespace-nowrap min-w-[80px] justify-center px-4 py-3 rounded-2xl bg-button text-white text-[10px] font-black uppercase tracking-widest transition-all shadow-lg shadow-blue-100 flex items-center border border-transparent">
                        Todos
                    </button>
