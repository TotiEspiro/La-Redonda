    ...
    <div class="container max-w-7xl mx-auto px-4 py-6 md:py-8">
        ...
        <div class="relative mb-10">
            <div class="text-center px-4 md:px-12">
                ...
                <p class="mt-4 text-text-light max-w-2xl mx-auto text-sm md:text-base">
                   Formación sacramental para niños de 7 a 12 años. Preparación para Primera Comunión.
                </p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 justify-center items-stretch">
            ...
            <div class="group bg-white border border-gray-200 rounded-xl hover:border-button hover:shadow-lg transition-all duration-300 flex flex-col overflow-hidden h-full">
                ...
                <div class="accordion-header md:cursor-default cursor-pointer bg-white select-none flex-shrink-0">
                    <div class="w-full bg-gray-100 relative md:h-72 flex items-center justify-center overflow-hidden">
                        <img src="{{ asset('img/catequesis_niños.jpg') }}" alt="Niños" class="w-full h-auto md:h-full object-cover block">
                    ...
                    <div class="p-4 flex items-center justify-between border-b border-transparent md:border-none">
                        <div class="flex flex-col">
                            <h3 class="font-bold text-text-dark text-lg">Catequesis Niños</h3>
                            <span class="text-xs text-button font-medium bg-blue-50 px-2 py-0.5 rounded-full inline-block w-fit mt-1">7 a 12 años</span>
                        </div>
                ...
                <div class="accordion-content hidden md:flex flex-col flex-grow p-6 pt-0 border-t md:border-t-0 border-gray-100 bg-white">
                    <p class="text-text-light text-sm mb-6 text-left flex-grow leading-relaxed">
                        En el grupo de catequesis preparamos a las familias, tanto a los chicos como a los padres al mismo tiempo. 
                        La catequesis de primera comunión es un proceso que dura dos años.
                    </p>
            ...
            <div class="group bg-white border border-gray-200 rounded-xl hover:border-button hover:shadow-lg transition-all duration-300 flex flex-col overflow-hidden h-full">
                ...
                <div class="accordion-header md:cursor-default cursor-pointer bg-white select-none flex-shrink-0">
                    <div class="w-full bg-gray-100 relative md:h-72 flex items-center justify-center overflow-hidden">
                        <img src="{{ asset('img/catequesis_adolescentes.png') }}" alt="Adolescentes" class="w-full h-auto md:h-full object-cover block">
                    </div>

                    <div class="p-4 flex items-center justify-between border-b border-transparent md:border-none">
                        <div class="flex flex-col">
                            <h3 class="font-bold text-text-dark text-lg">Adolescentes</h3>
                            <span class="text-xs text-button font-medium bg-blue-50 px-2 py-0.5 rounded-full inline-block w-fit mt-1">13 a 17 años</span>
                        </div>
                        <div class="accordion-chevron text-gray-400 transition-transform duration-300 md:hidden bg-gray-50 rounded-full p-1">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </div>
                ...
                <div class="accordion-content hidden md:flex flex-col flex-grow p-6 pt-0 border-t md:border-t-0 border-gray-100 bg-white">
                    <p class="text-text-light text-sm mb-6 text-left flex-grow leading-relaxed">
                        Espacio de formación y acompañamiento para jóvenes de 13 a 17 años. Preparación para la Confirmación y grupos juveniles.
                    </p>
                    <div class="flex items-center justify-center text-sm text-button font-medium bg-blue-50 py-3 rounded-lg mt-auto border border-blue-100 px-3 min-h-[3.5rem] text-center">
                        <img src="{{ asset('img/icono_horario.png') }}" class="mr-2 h-4 w-4 flex-shrink-0">
                        <span>Lunes 18:00 hs</span>
                    </div>
                </div>
            </div>
            ...
            <div class="group bg-white border border-gray-200 rounded-xl hover:border-button hover:shadow-lg transition-all duration-300 flex flex-col overflow-hidden h-full">
                ...
                <div class="accordion-header md:cursor-default cursor-pointer bg-white select-none flex-shrink-0">
                    <div class="w-full bg-gray-100 relative md:h-72 flex items-center justify-center overflow-hidden">
                        <img src="{{ asset('img/catequesis_mayores.jpg') }}" alt="Adultos" class="w-full h-auto md:h-full object-cover block">
                    </div>

                    <div class="p-4 flex items-center justify-between border-b border-transparent md:border-none">
                        <div class="flex flex-col">
                            <h3 class="font-bold text-text-dark text-lg">Adultos</h3>
                            <span class="text-xs text-button font-medium bg-blue-50 px-2 py-0.5 rounded-full inline-block w-fit mt-1">Mayores de 18</span>
                        </div>
                        <div class="accordion-chevron text-gray-400 transition-transform duration-300 md:hidden bg-gray-50 rounded-full p-1">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </div>
                ...
                <div class="accordion-content hidden md:flex flex-col flex-grow p-6 pt-0 border-t md:border-t-0 border-gray-100 bg-white">
                    <p class="text-text-light text-sm mb-6 text-left flex-grow leading-relaxed">
                        Formación continua para adultos. Profundización en la fe, Biblia y doctrina católica. Sacramentos de iniciación.
                    </p>
                    <div class="flex items-center justify-center text-sm text-button font-medium bg-blue-50 py-3 rounded-lg mt-auto border border-blue-100 px-3 min-h-[3.5rem] text-center">
                        <img src="{{ asset('img/icono_horario.png') }}" class="mr-2 h-4 w-4 flex-shrink-0">
                        <span>Martes 17:30 hs</span>
                    </div>
                </div>
            </div>
