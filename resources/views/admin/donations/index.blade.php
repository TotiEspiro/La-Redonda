                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden mx-1">
                    <div class="p-4">
                        <div class="flex justify-between items-start mb-1">
                            <div>
                                <h3 class="text-sm font-bold text-gray-900 leading-tight">{{ $donation->card_holder }}</h3>
                                <p class="text-xs text-gray-500 mt-0.5">{{ $donation->email }}</p>
                            </div>
                            <div class="text-right flex-shrink-0 ml-2">
                                <div class="text-lg font-bold text-green-600">${{ number_format($donation->amount, 2) }}</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between pt-3 border-t border-gray-100 text-xs text-gray-400">
                            <div class="flex items-center gap-1.5">
                                ...
                                <span class="font-mono">•••• {{ $donation->card_last_four }}</span>
                            </div>
                            <div class="flex items-center gap-1.5">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="font-bold text-green-600">${{ number_format($donation->amount, 2) }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
            ...
            <div class="p-4 md:p-6 space-y-4 md:space-y-0 md:grid md:grid-cols-2 md:gap-6">
                ...
                <div class="grid grid-cols-2 gap-3 md:gap-4">
                    <div class="p-3 md:p-4 bg-gray-50 rounded-xl border border-gray-100 text-center flex flex-col justify-center">
                        ...
                        <p class="text-xl font-bold text-gray-800">{{ $donations->count() }}</p>
                    </div>
                    <div class="p-3 md:p-4 bg-gray-50 rounded-xl border border-gray-100 text-center flex flex-col justify-center">
                        <p class="text-xs text-gray-500 uppercase font-bold mb-1">Promedio</p>
                        <p class="text-xl font-bold text-gray-800">${{ number_format($donations->avg('amount') ?? 0, 0) }}</p>
                    </div>
                </div>
            </div>
        </div>
