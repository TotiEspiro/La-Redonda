    ...
    <div class="container max-w-7xl mx-auto px-4 pt-8">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 mb-8 relative overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('profile.edit') }}" class="px-8 py-4 bg-button text-white rounded-2xl font-black hover:bg-blue-900 transition-all text-sm shadow-lg shadow-blue-100 uppercase tracking-widest">
                        Editar Perfil
                    </a>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                {{-- Preferencias de Alertas Granulares --}}
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        {{-- Validación de Grupo --}}
                        @php $inGroup = $user->roles->whereNotIn('name', ['admin', 'superadmin'])->isNotEmpty(); @endphp
                        @if(!$inGroup)
